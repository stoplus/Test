...
import com.test.R
import com.test.base.BaseAdapter
import com.test.base.BaseViewHolder
...
class ProductAdapter(
    private val clickListener: (ProductResult) -> Unit
) : BaseAdapter<ItemProductBinding, ProductResult>() {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        val binding = holder.viewBinding as ItemProductBinding
